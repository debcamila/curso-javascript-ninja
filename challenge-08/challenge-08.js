...
//obj de primeira classe: as funcoes tem o mesmo tratamento que os objetos {}, <3 , function(){}

function showName(){ //é uma funcao literal
  return 'Deborah Camila';
};
...
function calculator(sinal){
  return function(a, b){
    ...
    return 'Resultado da operação: ' +a+ '' +sinal+ '' +b+ ' = ' +result;
  };
}
