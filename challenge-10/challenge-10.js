(function(){
    ...
    */
    ...
    var concat = 10 + String(10);//passar uma String() pq to somando um numero com uma string e preciso concatenar
    ...
    */
    ...
    /* OU PODE FAZER ASSIM
    function isOperatorValid(operador){
        return !!operation[operador]; ou !== undefined
    } 
     */
    ...
    */
    ...
    function calculator(operador){
        if(!isOperatorValid (operador)){//o operador é valido? funcao que retorna booleano começa com 'has' ou 'is'
            return false;
        }
        return function isOperator(a,b){
